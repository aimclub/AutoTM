...
def calculate_attention_head_confidence(attention, tokens, sentences, encoder_attention=None,
        decoder_attention=None, cross_attention=None,
        encoder_tokens=None,
        decoder_tokens=None,
        include_layers=None,sentence_b_start=None,layer=None,
        heads=None,):
    attn_data = []
