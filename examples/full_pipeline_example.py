...
if __name__ == '__main__':
    ...
    # best_result, experiment_id = run_algorithm(data_path=SAVE_PATH,
    #                             exp_id=exp_id,
    #                             dataset='test',
    #                             topic_count=3,
    ...
    PATH_TO_MLFLOW_RESULTS = './mlflow'
    TEST_RUN_NAME = 'fitness-test-2ad5fbf9-45d6-4dfd-9b07-283d08ebb0e6'  # for now you can see the run name in console after each run

    # usage and inference
    process_experiment(PATH_TO_MLFLOW_RESULTS)
